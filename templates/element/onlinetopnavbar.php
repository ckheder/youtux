<!-- Barre de navigation des utilisateurs connectés -->
...
<header>
  ...
  <!-- input de recherche -->
    ...
    <a class="navbar-brand" href="/youtux/settings">
    ...
    <a class="navbar-brand" href="/youtux/n/i">
      <svg xmlns="http://www.w3.org/2000/svg" width="30" height="24" fill="currentColor" class="bi bi-bell" viewBox="0 0 16 16">
    ...
    <a class="navbar-brand" href="/youtux/<?= $authName ?>">
        <img src="/youtux/users/<?= $authName ?>/<?= $authName ?>.jpg" alt="image utilisateur" width="30" height="24" title="Mon profil">
    </a>

    <!-- lien de déconnexion -->

    <a class="navbar-brand" href="/youtux/logout">
      <svg xmlns="http://www.w3.org/2000/svg" width="30" height="24" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
