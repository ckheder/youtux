...
class NotificationsTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->setDisplayField('id_notification');
    ...
    {
        $validator
            ->scalar('user_notification')
            ->maxLength('user_notification', 50)
            ->requirePresence('user_notification', 'create')
            ->notEmptyString('user_notification');

        $validator
            ->scalar('notification_content')
            ->requirePresence('notification_content', 'create')
            ->notEmptyString('notification_content');
